...
public class PopulatedGUI extends JFrame {

	static String[] currentData = new String[12];
	...
	int i, index, ting, progress;
	private JTextField emailID;
	private JTextField country;

	public void showPopulatedGUI(int index) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				...
				try {
					...
					frame.setVisible(true);
					frame.firstName.setText(data[index][0]);
					frame.middleName.setText(data[index][1]);
					frame.lastName.setText(data[index][2]);
					frame.phoneNumber.setText(data[index][3]);
					frame.addLine1.setText(data[index][4]);
					frame.addLine2.setText(data[index][5]);
					frame.city.setText(data[index][6]);
					frame.state.setText(data[index][7]);
					frame.zipcode.setText(data[index][8]);
					if (data[index][9].equals("M"))
						frame.rdbtnMale.setSelected(true);
					else if (data[index][9].equals("F"))
						frame.rdbtnFemale.setSelected(true);
					frame.emailID.setText(data[index][10]);
					frame.country.setText(data[index][11]);
					frame.index = index;
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public PopulatedGUI() {
		...
		JLabel lblProgress = new JLabel("Progress: 10/10");
		...
		contentPane.add(middleName, "4, 4, 3, 1, fill, top");
		...
		contentPane.add(addLine2, "10, 4, fill, top");
		...
		// Update - Creating a button
		JButton updateButton = new JButton("Update");
		contentPane.add(updateButton, "2, 14, fill, top");

		// Clear - Creating a button
		JButton clearButton = new JButton("Clear");
		contentPane.add(clearButton, "8, 14, fill, top");

		// Delete - Creating a button
		JButton deleteButton = new JButton("Delete");
		contentPane.add(deleteButton, "4, 14, 3, 1, center, top");

		// Cancel - Creating a button
		JButton cancelButton = new JButton("Cancel");
		contentPane.add(cancelButton, "10, 14, right, top");
		...
		// Update button click event handling
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (!flag) {
					...
					if (firstName.getText().equals("")
						...
						contentPane.add(lblNewLabel, "2, 1, 7, 1");
